...
from model.swift.modeling_qwen2 import Qwen2ForCausalLM
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="llama",
        choices=["llama", "qwen2"],
        help="llama -> LlamaForCausalLM (modeling_llama.py). qwen2 -> Qwen2ForCausalLM (modeling_qwen2.py).",
    )
    ...
    model_cls = Qwen2ForCausalLM if args.model_family == "qwen2" else LlamaForCausalLM
